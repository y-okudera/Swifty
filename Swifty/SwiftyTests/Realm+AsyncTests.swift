...
final class Realm_AsyncTests: XCTestCase {
    ...
    private func asyncWriteGeneratedEntities(_ entities: [GeneratedEntity]) {
        ...
        dao.realm.writeAsync(configuration: dao.configuration(), objects: entities, writeCompletionOnMain: {
    ...
    private func asyncReadGeneratedEntities() {
        ...
        Realm.readAsync(configuration: dao.configuration(), backgroundBlock: { [weak self] realm in
